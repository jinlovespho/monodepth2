...
# -> Saving predicted disparities to  /media/dataset1/jinlovespho/log/monodepth2/monodepth2_baseline/models/weights_19/disps_eigen_benchmark_split.npy
# -> Evaluating
#    Mono evaluation - using median scaling
#  Scaling ratios | med: 30.225 | std: 0.100

#    abs_rel |   sq_rel |     rmse | rmse_log |       a1 |       a2 |       a3 | 
# &   0.092  &   0.544  &   3.987  &   0.139  &   0.912  &   0.982  &   0.995  \\
