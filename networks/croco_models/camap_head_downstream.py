...
from .camap_dpt_block import CAMap_DPTOutputAdapter


class CAMap_PixelwiseTaskWithDPT(nn.Module):
    ...
    * for encoder+decoder: last encoder + 3 equally spread layers of the decoder 
    ...
    def __init__(self, *, hooks_idx=None, layer_dims=[96,192,384,768],
        ...
        super(CAMap_PixelwiseTaskWithDPT, self).__init__()
    ...
    def setup(self, croconet):
        ...
        self.dpt = CAMap_DPTOutputAdapter(**dpt_args)
