...
from ..croco_models.pos_embed import RoPE2D
from ..croco_models.blocks import PositionGetter

class SF_Croco(nn.Module):
    def __init__(
        self,
        *,
        encoder,
    ...
    def forward(self, inputs):
        ...
        img_b, _, img_h, img_w = inputs['color_aug',0,0].shape
        ...
        pose=self.position_getter(img_b, img_h//16, img_w//16, x.device)
        
        glob = self.encoder.transformer(x, pose)                  # transformer의 encoder 하나를 전체 통과한 output
